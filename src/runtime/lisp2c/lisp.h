...
void position_if1(CL_FORM *base);
void position1(CL_FORM *base);
void find_if1(CL_FORM *base);
...
void substitute_if1(CL_FORM *base);
...
void delete_if1(CL_FORM *base);
void delete1(CL_FORM *base);
void remove_if_not1(CL_FORM *base);
void remove_if1(CL_FORM *base);
...
void Fsubstitute_if_not(CL_FORM *base, int nargs);
...
void Fnsubstitute_if_not(CL_FORM *base, int nargs);
void Ffind(CL_FORM *base, int nargs);
extern GLOBAL_FUNARG CFfind;
void vector_find(CL_FORM *base);
...
void FFI_c_char_p(CL_FORM *base);
void FFI_c_short_p(CL_FORM *base);
void FFI_c_int_p(CL_FORM *base);
void FFI_c_long_p(CL_FORM *base);
void FFI_c_unsigned_char_p(CL_FORM *base);
void FFI_c_unsigned_short_p(CL_FORM *base);
void FFI_c_unsigned_int_p(CL_FORM *base);
void FFI_c_unsigned_long_p(CL_FORM *base);
void FFI_c_float_p(CL_FORM *base);
void FFI_c_double_p(CL_FORM *base);
