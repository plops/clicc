...
extern CL_INIT XIformat21[];
extern CL_INIT XFformat21[];
CL_INIT Kformat21[] =
{
...
static void Z45_goto(CL_FORM *base, CL_FORM *display[]);
static void Z46_get_arg(CL_FORM *base, CL_FORM *display[]);
static void Z47_get_ctrl(CL_FORM *base, CL_FORM *display[]);
static void Z48_get_params(CL_FORM *base, CL_FORM *display[]);
static void Z49_get_at_sign_or_colon(CL_FORM *base, CL_FORM *display[]);
static void Z50_get_directive(CL_FORM *base, CL_FORM *display[]);
static void Z51_skip(CL_FORM *base, CL_FORM *display[], int nargs);
static void Z52_insert_space(CL_FORM *base, CL_FORM *display[]);
static void Z53_tabbing(CL_FORM *base, CL_FORM *display[], int nargs);
static void Z54_padding(CL_FORM *base, CL_FORM *display[], int nargs);
...
void format21(CL_FORM *base)
{
	...
	if(CL_CHARP(ARG(10)) && GET_CHAR(ARG(10)) == '~')
	{
		...
		display[0] = ARG(0);
		Z49_get_at_sign_or_colon(ARG(15), display);
		display[0] = ARG(0);
		Z50_get_directive(ARG(15), display);
		COPY(ARG(15), ARG(10));
		if(CL_CHARP(ARG(10)))
		{
			COPY(ARG(10), ARG(15));
		...
		if(CL_CHARP(ARG(15)) && GET_CHAR(ARG(15)) == 'A')
		{
			if(CL_TRUEP(ARG(11)))
			{
				...
				if(CL_TRUEP(ARG(13)))
				{
					...
					INIT_DOWN_FUNARG(downfun1, Z54_padding, -2, display);
		...
		else
		{
			...
			else
			{
				if(CL_CHARP(ARG(15)) && GET_CHAR(ARG(15)) == 'D')
				{
					COPY(ARG(0), ARG(16));
					COPY(ARG(16), ARG(17));
					LOAD_SMALLFIXNUM(5, ARG(18));
					COPY(ARG(17), ARG(19));
					LOAD_SYMBOL(SYMBOL(Slisp, 64), ARG(20));	/* STREAM */
					rt_struct_typep(ARG(19));
					if(CL_TRUEP(ARG(19)))
					{
						COPY(OFFSET(AR_BASE(GET_FORM(ARG(17))), GET_FIXNUM(ARG(18)) + 1), ARG(16));
					}
					else
					{
						COPY(SYMVAL(Slisp, 342), ARG(19));	/* NO_STRUCT */
						COPY(ARG(17), ARG(20));
						LOAD_SYMBOL(SYMBOL(Slisp, 64), ARG(21));	/* STREAM */
						Ferror(ARG(19), 3);
					}
					Ffuncall(ARG(16), 1);
					mv_count = 1;
					display[0] = ARG(0);
					Z46_get_arg(ARG(17), display);
					LOAD_NIL(ARG(18));
					BIND_SPECIAL(SYMBOL(Slisp, 477), ARG(18));	/* *PRINT-RADIX* */
					LOAD_SMALLFIXNUM(10, ARG(19));
					BIND_SPECIAL(SYMBOL(Slisp, 469), ARG(19));	/* *PRINT-BASE* */
					...
					COPY(ARG(16), ARG(21));
					display[0] = ARG(0);
					Z52_insert_space(ARG(20), display);
					RESTORE_SPECIAL;
					RESTORE_SPECIAL;
				}
				else
				{
					if(CL_CHARP(ARG(15)) && GET_CHAR(ARG(15)) == 'B')
					{
						...
						mv_count = 1;
						LOAD_NIL(ARG(17));
						BIND_SPECIAL(SYMBOL(Slisp, 477), ARG(17));	/* *PRINT-RADIX* */
						LOAD_SMALLFIXNUM(2, ARG(18));
						BIND_SPECIAL(SYMBOL(Slisp, 469), ARG(18));	/* *PRINT-BASE* */
						display[0] = ARG(0);
						Z46_get_arg(ARG(19), display);
						COPY(ARG(19), ARG(20));
						COPY(ARG(0), ARG(21));
						princ1(ARG(20));
						COPY(ARG(12), ARG(19));
						COPY(ARG(16), ARG(20));
						display[0] = ARG(0);
						Z52_insert_space(ARG(19), display);
						RESTORE_SPECIAL;
						RESTORE_SPECIAL;
					}
					else
						...
						else
						{
							...
							else
							{
								if(CL_CHARP(ARG(15)) && GET_CHAR(ARG(15)) == 'F')
								{
									...
									COPY(ARG(16), ARG(18));
									display[0] = ARG(0);
									Z52_insert_space(ARG(17), display);
								}
								else
								{
											...
											else
											{
												...
												else
												{
													...
													else
													{
														...
														{
															DOWN_FUNARG downfun1;
															INIT_DOWN_FUNARG(downfun1, Z53_tabbing, -2, display);
																			...
																			else
																			{
																				if(CL_CHARP(ARG(15)) && GET_CHAR(ARG(15)) == '{')
																				{
																					...
																					else
																					{
																						...
																						display[0] = ARG(0);
																						Z51_skip(ARG(19), display, 1);
																						if(CL_TRUEP(ARG(14)))
																						{
																							LOAD_SMALLFIXNUM(0, ARG(19));
																							if(EQL(ARG(19), ARG(12)))
																							{
																								goto ELSE10;
																							}
																							else
...
static void Z45_goto(CL_FORM *base, CL_FORM *display[])
{
	...
	if(EQL(ARG(0), ARG(2)))
	{
		...
		LOAD_SMALLFIXNUM(0, &display[0][7]);
...
static void Z51_skip(CL_FORM *base, CL_FORM *display[], int nargs)
{
	...
	M1_1:;
	Z47_get_ctrl(ARG(2), display);
	if(CL_TRUEP(ARG(2)))
	{
		if(CL_CHARP(ARG(2)) && GET_CHAR(ARG(2)) == '~')
		{
			Z48_get_params(ARG(3), display);
			Z49_get_at_sign_or_colon(ARG(3), display);
			Z50_get_directive(ARG(3), display);
			if(EQL(ARG(3), ARG(0)))
			{
				COPY(ARG(3), ARG(0));
				goto RETURN1;
...
static void Z53_tabbing(CL_FORM *base, CL_FORM *display[], int nargs)
{
	...
	if(CL_TRUEP(ARG(0)))
	{
		...
		if(CL_TRUEP(ARG(3)))
		{
			...
			if(CL_TRUEP(ARG(6)))
			{
				COPY(OFFSET(AR_BASE(GET_FORM(ARG(4))), GET_FIXNUM(ARG(5)) + 1), ARG(3));
			}
			else
			{
