...
static void Z37_lambda(CL_FORM *base, int nargs);
...
void substitute1(CL_FORM *base)
{
	...
	else
	{
		...
		{
			GEN_CLOSURE(array, ARG(10), 4, Z37_lambda, -1);
			COPY(ARG(5), &array[3]);
